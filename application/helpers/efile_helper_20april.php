...
function verify_digital_sinature($log_id,$draft_content = null){
	...
	if($query->num_rows() > 0){
		...
		if($response == '"success"'){
			...
			$return  = '<img src="'.base_url().'images/verify_sign.png" height="25px" width="30px" title="Signed by: '.$show_data.'"> <div style="font-size:10px">Digitally Signed By <br/><span class="onlyprint">'.$show_data.'</span></div>' ;
		} else { 
