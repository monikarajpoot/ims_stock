...
<form role="form" method="post" action="<?php echo base_url()?>manage/file<?php if(isset($id)){ echo '/'.$id;} ?>"  enctype="multipart/form-data">
<div class="col-md-6">
    <div class="box box-primary">
        <div class="box-body">
            ...
            <div class="form-group" id="other_file_div">
                <label for="file_type">
                    <?php if(checkUserrole()!='2' || checkUserrole()!='3' || checkUserrole()!='4' || checkUserrole()!='12' || checkUserrole()!='25' || checkUserrole()!='5'){
                                echo 'दस्तावेज प्राप्ति का प्रणाली';
                            }else{  echo $this->lang->line('other_label');} ?>
                ...
                <select class="form-control" name="other_file_type" id="other_file_type">
                    ...
                    foreach(file_other_type() as $key => $value){
                        if($key!='1' && $key!='2' && $key!='3' && $key!='4' && $key!='5' && (checkUserrole()!='2' || checkUserrole()!='3' || checkUserrole()!='4' || checkUserrole()!='12' || checkUserrole()!='25')){
            ...
            <div class="form-group">
                <label for="file_uo_date" id="dispaly_date"><?php if ($abc == 'l' or $abc == 'a' or $abc == 'o') { echo $this->lang->line('label_letterno_date') ;} else if ($abc == 'r') { echo $this->lang->line('label_registry_date') ;}else if ($abc == 'n') { echo $this->lang->line('label_notice_date') ;} else {  echo  $this->lang->line('label_uo_date');}?>
                </label> <span class="text-danger">*</span></label>
                <input type="text" name="file_uo_date" id="file_uo_date" value="<?php if ($this->input->post('file_uo_date')){ echo $this->input->post('file_uo_date');}  ?>" placeholder="<?php echo $this->lang->line('placeholder_dispatch_date'); ?>" class="form-control date1">
...
<div class="col-md-6">
    <div class="box box-primary">
        <div class="box-body">
			...
			<?php if(emp_session_id()!=2 && $login_user_role_id!=5 && $login_user_role_id!=6){ ?>
            <div class="form-group">
                ...
                <input type="hidden" name="mark_unitid" id="mark_unitid" value="">
			...
			<?php } ?>
			<div class="form-group show_for_procescution" style="display:none">
					<label for="prosecution file type"><?php echo $this->lang->line('file_ka_prakar'); ?> </label>
