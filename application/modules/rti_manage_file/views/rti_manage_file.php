...
<div class="col-md-6">
    <div class="box box-primary">
        <div class="box-body">
			...
			<div class="form-group">
                <label for="rti_file_serial_no" id="rti_file_serial_no"><?php echo $this->lang->line('label_serial_no')?></label> <span class="text-danger">*</span></label>
			...
			<div class="form-group">
                <label for="rti_file_hearing_date" id="rti_file_hearing_date"><?php echo $this->lang->line('label_hearing_date')?></label> <span class="text-danger">*</span></label>
                <input type="text" name="hearing_date" id="hearing_date" required value="<?php echo isset($hearing_date) ? $hearing_date : date('d-m-Y'); ?>" placeholder="<?php echo $this->lang->line('label_hearing_date'); ?>" class="form-control date1">
                <?php echo form_error('rti_file_applicant_firm_name');?>
            </div>
            ...
            <?php if($file_type!='n'){ ?>
                <div class="form-group hide_for_notice" id="" >
                    <label for="RTI_fees" id="RTI_fees"><?php echo $this->lang->line('rti_file_fee').' Rs'?></label> <span class="text-danger">*</span></label>
