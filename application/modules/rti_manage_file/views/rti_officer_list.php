                            ...
                            <td class="no-print">
                                <div class="btn-group">
                                    ...
                                    <!--<a href="<?php echo base_url();?>dashboard/receive_edit/<?php echo $files->file_id; ?>" class="btn btn-twitter"><span class="blink_fast">Receive</span></a>-->
                                        <a onclick="return confirm_receive()" href="<?php echo base_url();?>rti_manage_file/rti_files_edit/receivebyofficer/<?php echo $files->file_id; ?>" class="btn btn-twitter"><span class="blink_fast">Receive</span></a>
                                    <?php }else {
