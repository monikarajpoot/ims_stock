                        ...
                        echo    $files->file_Offer_by == 'sc' ? 'दिल्ली सुप्रीम कोर्ट ' : false;
                            ...
                            <td class="no-print">
                               <?php if($files->file_hardcopy_status == 'not') { ?>
                                   <a onclick="return confirm('Are you sure you want to receive this file')" href="<?php echo base_url();?>manage_file/receive_by_officer/<?php echo $files->file_id; ?>?ft_status=p" class="btn btn-block btn-sm btn-twitter"  data-toggle="tooltip" data-original-title="Receive file"><span class="blink_fast" ><?php echo $this->lang->line('receive_file') ?></span></a>
                        <?php }else{ ?>
