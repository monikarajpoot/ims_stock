...
<section class="content">
    ...
    <div class="row" id="divname">
        ...
        <!-- for Ps monitor.-->
        <div id="psmonitor"  <?php echo @$this->input->post('search_type') == '12' ? "style='display: block'" : "style='display: none'"?>>
            ...
            <th><?php echo $this->lang->line('sno'); ?></th>
									  ...
									  <?php }  else { ?>
									   ...
									   <?php } ?>
										...
										<?php if(isset($_GET['task']) && $_GET['task']=='reopen' || $_GET['task']=='fileedit' ){?>
                                            ...
                                            <tr <?php if(!isset($_GET['task']) && $_GET['task']!='reopen'){?> onClick="showcomp(<?php echo $file->file_id; ; ?>)" <?php } ?> style="cursor:pointer"; data-toggle="tooltip" data-original-title="View file">
                                                ...
                                                <?php } else if(isset($_GET['task']) && $_GET['task']=='fileedit'){?>
                                                    <td>
                                                        ...
                                                        <?php if(($files[0]->file_hardcopy_status=='received' || $files[0]->file_hardcopy_status=='working') && $files[0]->file_received_emp_id==$this->session->userdata("emp_id")){ ?>
                                                            <a class="btn bg-olive margin"  href="<?php echo base_url();?>dashboard/dealing/<?php echo $files[0]->file_id;?>">बदलाव करें</a>
                                                        <?php }else {?>
                                                            <b class="text-red">
...
<script type="text/javascript">
    $('#search_type').change(function(){
        ...
        if($typeval == '4'){
            ...
            $("#psmonitor").show();
            $("#dis2,#dis1,#dis4,#dis4_1,#dis3").hide();
            ...
            $("#dis2,#dis3").hide();
            $(".show_movement_dt,.show_search_dt_filter, .dispatch_block,#psmonitor").hide();
        }else if($typeval == '9'){
            ...
            $(".show_movement_dt, .dispatch_block,#psmonitor").hide();
            $(".show_case").hide();
            $("#dis4,#dis4_1,#dis1").hide();
            $("#dis2,#dis3").hide();
			$('.rmv_required').prop('required', true);
        }else if($typeval == '11'){
            $(".show_movement_dt,.show_search_dt_filter, .show_case,#psmonitor").hide();
            $("#dis4,#dis4_1,#dis1").hide();
            $("#dis2,#dis3").hide();
		    $(".dispatch_block").show();
        } else{
