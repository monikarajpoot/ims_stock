                    ...
                    <div class="table-responsive">
                        <table id="view_table" class="table table-bordered table-striped display">
                            ...
                            <?php $i=1; foreach ($get_files as $key => $files) {
                                ...
                                ?>>
                                    <td title="<?php echo $files->file_id;?>"><?php echo $i;?> <span <?php if($section_id == 1) { }else { ?>  style="display:none" <?php } ?>> <span style="display:none">(<?php echo "<b>File ID</b>"; ?> : <?php echo $files->file_id;?>)</span></span>
										<br/>
                                        CR-<?php @$fno = getfilesec_id_byfileid($files->file_id,'1',$files->file_type,$files->file_mark_section_id);
                                if($fno==null){ 
									//echo 'N/A';
									echo getfilesec_id_byfileid($files->file_id,'1',$files->file_type,100);
									}else{ echo $fno;}?></td>
