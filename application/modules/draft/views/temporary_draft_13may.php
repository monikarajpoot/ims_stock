                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group text_editor" id="text_editor" >
							...
							<div  class="show_content" >
								...
								<div  style="width:50%; text-align:center;">(Digitally Signed)</div>
								<div class="officer-center"> <div> ( <?php echo  get_officer_information($this->input->post('sing_user'));  ?> )</div></div>
								<div class="officer-center"><div><?php echo $officer_dign; ?></div></div>
...
function save_notesheet(){
	...
	//alert(content1 + '- '+ d_type +' -'+ file_id + ' - ' +section_id +' - '+ officer_id);
