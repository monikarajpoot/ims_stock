        ...
        <div class="box box-primary">
            ...
            <div class="box-body" style="overflow: auto;height: 300px;">
                ...
                <div class="form-group">
                    ...
                    <?php echo (@$file_details[0]['case_no'] ? preg_replace('/[,]+/', '/', trim($file_details[0]['case_no'])) : '' ); ?>
                </div>
                <?php } ?>
                ...
                <div class="form-group">
                    <label for="exampleInputEmail1">निराकरण दिनांक : </label>
                ...
                <div class="form-group">
                    ...
                    if ($filereceiver)
                    {
                        if($file_details[0]['file_hardcopy_status'] == 'not') {
                            ...
                            echo "<span style='color:#ff0000' >Closed by <b> ".ucfirst($filereceiver[0]->emp_full_name)."</b> (".$filereceiver[0]->emprole_name_hi.")</span>";
                        } elseif($file_details[0]['file_hardcopy_status'] == 'working')  {
                            echo "<span style='color:#00a65a' >Work in progress by <b> ".ucfirst($filereceiver[0]->emp_full_name)."</b> (".$filereceiver[0]->emprole_name_hi.")</span>";
                        }  } ?>
                </div>
                <?php if($file_details[0]['file_upload'] != null && $file_details[0]['file_upload'] != ''){ ?>
                    <div class="form-group">
                        <label for="exampleInputFile">Uploaded Doc : </label>
                            ...
                            if($row1['fmove_current_user_id'] != $row1['fmove_previous_user_id']){
                                ...
                                <tr align="center"><td><?php  echo date_format(date_create($row1['fmove_created_datetime']), 'd/m/Y g:ia'); ?></td>
                                    ...
                                    <td>
                                        ...
                                        <?php echo $row1['file_return'] == '2' ? 'DISPATCH <i class="fa fa-fw fa-external-link"></i>' : false ; ?>
                                     </td>
                                </tr>
                            <?php }} ?>
                    </table>
                            ...
                            <td><?php
                                if($row['to_emp_id'] == $row['from_emp_id']){
                                    if (isset($empnmto[0]->emp_full_name)) {
                                        echo "File in progress by <b>" . ucfirst($empnmto[0]->emp_full_name) . "</b> (" . $empnmto[0]->emprole_name_hi . ")";
                                    }
                                } else {
