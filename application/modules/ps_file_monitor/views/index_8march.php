        ...
        <div class="col-xs-12">
            <div class="box" style="overflow: auto" id="divname"> 
                <div class="box-header">
					...
					<div class="color-palette-set col-sm-4 col-md-10">
					...
					<!--<div style="padding-left: 256px;padding-top:34px;clear:both">
						  <a class="text-green" href="<?php echo base_url();?>&sort=rc" style="padding:0px 7px 0px 0px;"><i class="fa fa-square badge bg-purple">&nbsp;Received/Working</i></a>
						  <a class="text-red" href="<?php echo base_url()?>&ps_file_monitor?sort=close" style="padding:0px 7px 0px 0px"><i class="fa fa-square badge bg-purple">&nbsp;Dispose/Dispetch</i></a>
						  <a class="text-red" href="<?php echo base_url();?>ps_file_monitor" style="padding:0px 7px 0px 0px"><i class="fa fa-square badge bg-purple">&nbsp;All Files</i></a>
					</div>-->
			    </div>
                ...
                <table id="view_table" class="table table-bordered table-hover">
                    ...
                    { $bgcolor="background-color:#FFE7BA ;";
                        ...
                        <td onClick="showcomp(<?php echo $files->file_id; ; ?>)"><span <?php echo $addblink ; ?>><?php echo $files->file_subject;?></span>
							...
							<!--<div style="float:right"><b><?php  //if(($files->ps_moniter_date != '0000-00-00') && ($files->ps_moniter_date !='1970-01-01')){ echo (@$files->ps_mark_monitor_date)? 'Monitor Mark Date :<span id="old_mdf'.$files->file_id.'">'. date('d-m-Y' , strtotime($files->ps_mark_monitor_date)):'</span>'; '<br/>'; echo (@$files->ps_moniter_date)? '<br/>Response Date :<span id="mdf'.$files->file_id.'">'. date('d-m-Y' , strtotime($files->ps_moniter_date)):'</span>'; } ?></b></div>-->
