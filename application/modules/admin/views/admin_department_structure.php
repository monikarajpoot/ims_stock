                ...
                <form role="form" method="post" action="<?php echo site_url(); ?>admin/admin_department/addUpdatedepartment<?php if(isset($dpid)){ echo '/'.$dpid;} ?>">
                    <div class="box-body">
                         <div class="tree well">
                            <ul>
                                <li>
                                    <span class="bg-success"><i class="icon-folder-open" ></i> <?php //echo getemployeeRole(3); ?>विरेन्दर सिंह/ <?php echo getemployeeRole(3); ?></span> 
                                <?php if(!empty($this->depart_struct->get_departmental_structure(2))){
                                    echo " <ul>";
                                    foreach($this->depart_struct->get_departmental_structure(2) as $row){ ?>
                                        <li>
                                            <span class="<?php echo get_role_class($row->designation_id); ?>"><i class="icon-minus-sign"></i><?php echo $row->emp_full_name_hi; ?> / <?php echo getemployeeRole($row->designation_id); ?></span>
                                             <?php if(!empty($this->depart_struct->get_departmental_structure($row->emp_id))){ ?>
                                                  <ul>
                                                   <?php  foreach($this->depart_struct->get_departmental_structure($row->emp_id) as $row1){ ?>
                                                        <li>
                                                            <span class="<?php echo get_role_class($row1->designation_id); ?>"><i class="icon-minus-sign"></i><?php echo $row1->emp_full_name_hi; ?> / <?php echo getemployeeRole($row1->designation_id); ?></span>
                                                             <?php if(!empty($this->depart_struct->get_departmental_structure($row1->emp_id))){ ?>
                                                                    <ul>
                                                                        <?php  foreach($this->depart_struct->get_departmental_structure($row1->emp_id) as $row2){ ?>
                                                                             <li>
                                                                                 <span class="<?php echo get_role_class($row2->designation_id); ?>"><i class="icon-minus-sign"></i><?php echo $row2->emp_full_name_hi; ?> / <?php echo getemployeeRole($row2->designation_id); ?></span>
                                                                                  <?php if(!empty($this->depart_struct->get_departmental_structure($row2->emp_id))){ ?>
                                                                                        <ul>
                                                                                            <?php  foreach($this->depart_struct->get_departmental_structure($row2->emp_id) as $row3){ ?>
                                                                                                 <li>
                                                                                                     <span class="<?php echo get_role_class($row3->designation_id); ?>"><i class="icon-minus-sign"></i><?php echo $row3->emp_full_name_hi; ?> / <?php echo getemployeeRole($row3->designation_id); ?></span>
                                                                                                      <?php if(!empty($this->depart_struct->get_departmental_structure($row3->emp_id))){ ?>
                                                                                                             <ul>
                                                                                                                <?php  foreach($this->depart_struct->get_departmental_structure($row3->emp_id) as $row4){ ?>
                                                                                                                     <li>
                                                                                                                         <span class="<?php echo get_role_class($row4->designation_id); ?>"><i class="icon-minus-sign"></i><?php echo $row4->emp_full_name_hi; ?> / <?php echo getemployeeRole($row4->designation_id); ?></span>
                                                                                                                          <?php if(!empty($this->depart_struct->get_departmental_structure($row4->emp_id))){ ?>
                                                                                                                              <ul>
                                                                                                                                <?php  foreach($this->depart_struct->get_departmental_structure($row4->emp_id) as $row5){ ?>
                                                                                                                                     <li>
                                                                                                                                         <span class="<?php echo get_role_class($row5->designation_id); ?>"><i class="icon-leaf"></i><?php echo $row5->emp_full_name_hi; ?> / <?php echo getemployeeRole($row5->designation_id); ?></span>
