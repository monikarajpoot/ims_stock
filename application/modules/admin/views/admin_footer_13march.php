...
function open_file(scan_id,file_path)
	     ...
	     function show_current_file()
 {
    ...
    document.getElementById("show_current_file").innerHTML='<object type="text/html" data="'+HTTP_PATH+'" width="100%"></object>';
 }
</script>
    ...
    <div class="modal-dialog" id="div_current">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="fa fa-fw fa-arrow-right shake"></i> स्वयं को अंकित फाइलें </h4>
                </div>
                <div class="modal-body">
                                <div class="col-xs-12">
                                    <div id="show_current_file"></div>
                                  <?php// echo modules::run('admin/admin_dashboard/show_current_file'); ?>
                    </div><!-- /.box-body -->
                </div>
                <div class="modal-footer">
