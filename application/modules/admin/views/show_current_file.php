...
<div id="divcurr">
    ...
    <table border="1px" cellspacing="0" align="center" width="100%" >
        ...
        <tr align="center" style="background: #BEDEDE;">
            ...
            <td><?php   echo $today_dispatch['today_dispatch']; ?></td>
            <td>
                <?php  $pending_work =  $total_file +  $today_dispatch['today_dispatch'] ; ?>
              <?php $formula = "(".$today_dispatch['today_dispatch']."/".$pending_work.")*100 :";  ?>
                <b title="<?php echo $formula ; ?>"> <?php $pre = ($today_dispatch['today_dispatch']/$pending_work)*100 ; ?><?php echo sprintf ("%.2f", $pre); ?> %</b>
            </td>
        </tr>
    </table>
...
<?php unset($userid_r,$old_pending,$total_file,$marked,$marked_today,$today_dispatch,$marked_file); // unset varible ?>
