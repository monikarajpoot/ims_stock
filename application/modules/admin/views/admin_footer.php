...
<?php if($this->uri->segment(1)=='admin'|| $this->uri->segment(1)=='dashboard' || $this->uri->segment(1)=='advocate' || $this->uri->segment(1)=='data_entry' ||$this->uri->segment(1)=='leave'|| $this->uri->segment(2)=='add_employee' || $this->uri->segment(2)=='edit_employee' || $this->uri->segment(2)=='manage_user' || $this->uri->segment(2)=='notesheets' || $this->uri->segment(1)=='add_file' || $this->uri->segment(2)=='add_file' || $this->uri->segment(2)=='dealing' || $this->uri->segment(2)=='file_search' || $this->uri->segment(2)=='edit_file' || $this->uri->segment(2)=='allot' || $this->uri->segment(2)=='save_dealing'|| $this->uri->segment(2)=='rti_file' || $this->uri->segment(1)=='show_file' || $this->uri->segment(1)=='view_file' || $this->uri->segment(1)=='activity_report' || $this->uri->segment(1)=='add_scan_files' || $this->uri->segment(1)=='manage_scan_files' || end($this->uri->segments)=='file' || $this->uri->segment(1)=='admin_notesheet_master'){ ?>
