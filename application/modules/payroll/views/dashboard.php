    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box box-primary">
               ...
               <div class="col-xs-2">
    <a target="_blank" id="<?php echo $sal_Cate->pay_cate_id; ?>" href="<?php echo base_url(); ?>payroll/showsalary_cate/<?php echo $sal_Cate->pay_cate_id; ?>"  class="btn btn-block btn-info" ><?php echo $sal_Cate->pay_cate_name; ?></a><br/>
    </div>
    <?php }?>
            </div><!-- /.box --></div>
        </div>
