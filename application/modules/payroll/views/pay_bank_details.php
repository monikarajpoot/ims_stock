<?php //pre($emp_bank);
    foreach ($emp_bank as $key => $pay) {?>
     <div class="form-group">
      ...
      <div class="form-group">
                <label for="file_type"><?php echo $this->lang->line("bank_branch_name");?></label> <span class="text-danger">*</span></label>
