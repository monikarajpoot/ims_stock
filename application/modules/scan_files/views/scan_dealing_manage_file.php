                ...
                <div class="form-group">
					...
					<div <?php if($sed_id == 11 || $sed_id == 12 || $sed_id == 13 || $sed_id == 19) { echo "style='display: none'"; } else { echo "style='display: block'";} ?>>
                    	...
                    	<div class="form-group text-center">
							...
							<a class="btn bg-maroon" href="<?php echo base_url(); ?>scan_files/dealing_scan_files/index/<?php echo $this->uri->segment(3)?>" >Browse File</a>
												<button type="button" onclick="open_model_csu(<?php echo $file_data[0]['file_id']; ?>);" class="btn bg-purple">Mark to scan unit</button>
