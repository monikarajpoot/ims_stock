...
<?php $emprole1 = emp_roleid($file_details[0]['file_received_emp_id']); // for check fileid is belongs to csu or not
	if($emprole1['role_id'] != checkUserrole()){redirect('show_file/csu');}  ?>
...
<form role="form" method="post" action="<?php echo base_url()?>scan_files/csu_upload_files_manage<?php if(isset($id)){ echo '/'.$id;} ?>"  enctype="multipart/form-data" id="scan_form">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        //$('#meta_key').val(insertText+','+insertText1+','+insertText4+','+insertText3);
