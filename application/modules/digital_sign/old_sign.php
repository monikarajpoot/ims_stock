...
$username = "dbadmin";
$password = "password";
//if(strpos($_SERVER['other'], 'eoffice')){
	//$dbname = "db_eoffice";
//} else {
	$dbname = "db_eoffice";	
//}
...
if(isset($_REQUEST['file_id']) && $_REQUEST['file_id']!=''){	//file id use as a draft creator Id
$draft_log_creater= $_REQUEST['file_id'];
...
if($signature !=''){
	 $ds_local_data=$_REQUEST['other'];
		$insert_sql = "INSERT INTO ft_digital_signature(ds_signature,ds_signed_data,ds_public_key,ds_verification_status,ds_emp_name,ds_draft_log_id,ds_create_datetime,ds_emp_id,ds_local_data)VALUES('".$signature."','".$s_c_data."','".$public_key."','".$verification_status."','".$emp_name."',".$draft_log_id.",'".$date."',".$draft_log_creater.",'".$ds_local_data."')";
