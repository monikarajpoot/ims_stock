    ...
    <div class="col-md-12">
        <div class="box box-danger">
            <div class="box-header" align="center">
                <?php
                    $dispatch_data = get_list(FILES_DISPATCH,null,array('file_id'=>$file_details[0]['file_id']));
...
<div class="col-md-6"  style="margin-top: 15px;">
    ...
    <div class="box box-primary">
        ...
        <?php if($file_details[0]['file_linked_id'] != '' &&  $file_details[0]['file_linked_id'] != 0) { ?>
            <div class="col-xs-12">
                <label for="exampleInputEmail1">एकीकृत नस्ती  : </label>
...
<?php if(!empty($file_details[0]['scan_id'])){
								show_scan_file($file_details[0]['scan_id']);
							}?>               
			   </div>
            <?php } ?>
                            ...
                            <tr>
                                ...
                                <td>
									...
									<?php if($row['document_path'] != '') {
                                            ...
                                            //    echo $path_r;
                                            ?>
                                                <a title="Show document" style="margin-left:5px" href="<?php echo base_url().'/'.$path_r;  ?>" target="_blank"><img height="30" width="30" src="<?php echo base_url();?>images/edit.png" style="height:15px !important; width:15px !important"> </a>
                                        <?php }} ?>
                                </td>
                            </tr>
...
foreach($mearge_file as $mearge_file1){
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-warning">
                <div class="box-header" align="center">
                    <h4 class="box-title">एकीकृत नस्ति id : <?php echo $mearge_file1 ?> पंजी क्रमांक : <?php
                ...
                <div class="box-body  fix-body"  >
                    <div class="form-group">
                        <table width="100%">
                            ...
                            <?php foreach($file_meargelog as $row){
                                // if($row['to_emp_id'] != $row['from_emp_id']){
                                $empnmto = get_user_details($row['to_emp_id']);
                                $empnmfrom = get_user_details($row['from_emp_id']);
                                $sublogin = get_user_details($row['sublogin']);
