...
<section class="content">
    ...
    <div class="row" id="divname">
		...
		<div class="col-xs-12 no-print" > 
			...
			<form method="post" action="<?php echo base_url(); ?>show_file/ALL" class="no-print">
                            ...
                            <td class="no-print">
                                <div class="btn-group">
                                    ...
                                    <!--<a href="<?php echo base_url();?>dashboard/receive_edit/<?php echo $files->file_id; ?>" class="btn btn-twitter"><span class="blink_fast">Receive</span></a>-->
                                       <?php echo  (emp_session_id() == $files->file_received_emp_id)  ? '<a data-toggle="tooltip" data-original-title="वापस  शाखा में भेजें"  onclick="open_model_cr('.$files->file_id.')" class="btn btn-block btn-sm btn-danger" data-toggle="tooltip" data-original-title="Reject"><i class="fa fa-reply"></i> अस्वीकारे</a>' : false; ?>
