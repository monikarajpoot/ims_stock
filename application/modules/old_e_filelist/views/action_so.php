                        ...
                        <form role="form" method="post" action="<?php echo base_url()?>view_file/dealing_file/sent_to_da">
                            ...
                            <div class="box-body">
                                ...
                                <div class="box-footer">
                                    <button class="btn btn-success" type="submit">Send To DA</button>
								    <button onclick="return confirm('Are you Sure to return this file to CR section');" type="submit" name="return_tocr" value="return_tocr" class="btn btn-default" data-toggle="tooltip" data-original-title="Only fill remark for return file">Return To CR</button>
                                    </div>
                            </div>
                        </form>
                        <!-- /.box-body -->
