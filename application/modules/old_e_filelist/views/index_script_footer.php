                        ...
                        <div class="box-body">
                            <div class="row">
								...
								<div class="form-group pull-right">
										<input type="checkbox" id="physical_file" name="file_status[]"  value="P" <?php if($this->uri->segment(1) != 'e-files'){ echo "checked"; }?>>Physical File 
										<input type="checkbox" id="electronic_file" name="file_status[]" value="E" <?php if($this->uri->segment(1) == 'e-files'){ echo "checked"; }?> >E-File
								</div>
							</div>
                        </div>
                    </div><!-- /.box-body -->
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="form-group text-right">
                                        <input type="checkbox" id="only_rec" name="only_rec" class="only_rec"> केवल प्राप्त करे
                                    </div>
