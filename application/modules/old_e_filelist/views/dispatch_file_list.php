                    ...
                    <tbody>
						...
						<tr class="row-gap">
							...
							<?php if( $files->file_hardcopy_status == 'received' && emp_session_id() == $files->file_received_emp_id && $files->file_return == '2' ){ ?>
							 ...
							 <?php } else if($files->file_hardcopy_status != 'close') { ?>
							...
							<table id="multiple_dispatch" class="m_dispatch gridtable" border="1px" style="font-size:13px;" width="100%">
								...
								<tfoot>											
									<tr><td style="text-align: left;">
										<button id="btn-delete" type="submit" class="btn btn-primary" onclick="return confirm('क्या आप  करना  चाहते है!');"><i class="fa fa-check"></i> <?php echo $this->lang->line('receive_file'); ?></button>
									</td>
									<td>
