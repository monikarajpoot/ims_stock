                ...
                <div class="box-body">
                    ...
                    if(isset($get_files)){ 
                        if(!empty($get_files)) { ?>
                            <div class="col-md-12" style="overflow: auto">
                                <?php if(count(@$get_files)>0){ ?>
                                    ...
                                    <div style="float:right;font-size: 18px;width:100%;background-color: #E2DCDC;">
                                        ...
                                        <div style="float:left;float:right">Total Number of Files: <b><?php echo count($get_files);?></b></div>
                                    </div>
                                <?php } ?>
                                        ...
                                        if(is_array($files)){
                                           foreach ($files as $key1 => $file) {  ?>
                                            <tr onClick="showcomp(<?php echo $file->file_id; ; ?>)" style="cursor:pointer"; data-toggle="tooltip" data-original-title="View file">
                                                <td><?php echo $i;?> (<?php echo $this->lang->line('file_no'); ?> : <?php echo $file->file_id;?>)</td>
                                               ...
                                               <td><?php $dispetch_date_array= get_file_dispos_date(null,$file->file_id); echo $dispetch_date_array['dispatch_date'];?></td>
                                                <td align=""><?php							
                            ...
                            <td ><?php echo $i;?> <span class="no-print"> (<?php echo $this->lang->line('file_no'); ?> : <?php echo $files->file_id;?>) </span></td>
                           ...
                           <td><?php $dispetch_date_array= get_file_dispos_date(null,$files->file_id); 
                                 if($dispetch_date_array['dispatch_date']!=''){
                                    echo date_format(date_create($dispetch_date_array['dispatch_date']), 'd/m/y');
                                 }else{
                                    echo 'N/A';
                                 }
