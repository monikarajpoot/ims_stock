                        ...
                        <form role="form" method="post" action="<?php echo base_url()?>view_file/Dealing_file/Sent_to_DA">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="exampleInputFile">Remark on File </label>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputFile">Dealing Assistant Name <span class="text-danger">*</span></label>
                                    <select class="form-control" name="Da_name" >
                                        <option value="">Select</option>
                                        <?php foreach($dealing_name as $daname) { ?>
                                            <option value="<?php echo $daname['emp_id']; ?>"><?php echo ucfirst($daname['emp_full_name']); ?> (Dealing Assistant)</option>
                                        <?php } ?>
                                    </select>
                                ...
                                <div class="box-footer">
                                    <button class="btn btn-success" type="submit">Send To DS</button>
                                    <button onclick="return confirm('Are you Sure to return this file');" type="submit" name="return_tocr" value="return_tocr" class="btn btn-default" data-toggle="tooltip" data-original-title="Only fill remark for return file">Return To CR</button>
                                </div>
                            </div>
                        </form>
                        <!-- /.box-body -->
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                if(isset($file_details[0]['file_Offer_by'])) {
                                    ...
                                    echo    $file_details[0]['file_Offer_by'] == '0' ? $file_from[$file_details[0]['file_Offer_by']] ." , ". $file_details[0]['district_name_hi'] : false;
                                } ?>
                            </div>
                            <div class="form-group">
