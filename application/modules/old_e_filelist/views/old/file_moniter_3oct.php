            ...
            <div class="box" style="overflow: auto" id="divname"> 
                ...
                <table id="view_table" class="table table-bordered table-hover">
                    ...
                    <?php $i=1; foreach ($get_files as $key => $files) { ?>
                        ...
                        <td><?php echo $files->file_subject;?><br><div style="float:right"><b><?php echo (@$files->ps_moniter_date)? 'Mark Date :'. date('d-m-Y' , strtotime($files->ps_moniter_date)):''; ?></b></div></td>
                        ...
                        <td><?php echo @getfilesec_id_byfileid($files->file_id,$files->file_mark_section_id) ? getfilesec_id_byfileid($files->file_id,$files->file_mark_section_id) : 'N/A'; ?></td>
