                ...
                <div class="box-body">
                    <div class="col-md-12"> 
						...
						<div class="col-xs-3" id="dis4" <?php echo @$this->input->post('search_type') == '1' ? "style='display: block'" : "style='display: none'"?>>
                            ...
                            <div  class="show_search_dt_filter no-print" <?php echo @$this->input->post('search_type') == '10' ? "style='display: block'" : "style='display: none'"?>>
                                <div class="col-xs-2">
                                    <select id="filter_section_emp_wise" required name="filter_section_emp_wise" class="form-control">
                                ...
                                <div class="col-xs-2">
                                    <select id="section_emp_list" name="empid_secid" class="form-control" required>
                                        <option value="">Select employee/Section</option>
                                    </select>
                                    <?php echo form_error('empid_secid');?>
                                </div>
                                <div class="col-xs-2">
                                    <input type="text" placeholder="From Date" required name="search_frm_dt" id="search_frm_dt" autocomplete="off" value="<?php echo $frm_date; ?>"  class="form-control ps_moniter_date">
                                    <?php echo form_error('search_frm_dt');?>
                                </div>
                                <div class="col-xs-2">
                                    <input type="text" placeholder="To Date" required name="search_to_dt" id="search_to_dt" autocomplete="off"  value="<?php echo $to_date; ?>" class="form-control ps_moniter_date">
                    ...
                    if(isset($get_files)){ 
                        ...
                        <?php } ?>
                            ...
                            <td><?php
                                if(isset($file->section_number)){
                                    echo $file->section_number;

                                } else {
                                    $name_sec = getfilesec_id_byfileid($file->file_id,$file->file_mark_section_id,$file->file_type);
                                    if(!empty($name_sec)){
                                        echo $name_sec;
                                    }else{
                                        echo 'Na/na';
                                ...
                                @$file->section_number ? $file->section_number : getfilesec_id_byfileid($file->file_id,$file->file_mark_section_id,$file->file_type)
                                ?></td>
