                ...
                <div class="box-header">
                 ...
                 <?php if($this->session->flashdata('update') || $this->session->flashdata('insert') || $this->session->flashdata('delete') ){ ?>  <div class="alert alert-success alert-dismissable hideauto">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                    <?php if(count(@$get_notice)>0) {?>
                      <?php $i=1; foreach (@$get_notice as $key => $notice) { ?>
                        <tr>
                          <td><?php echo $i;?></td>
                          ...
                          <td><?php echo date("d-m-Y", strtotime($notice['notice_created_date'])) ." - ".date("d-m-Y", strtotime($notice['notice_created_date'])) ; ?></td>
