                      ...
                      <?php $i=1; //pre($get_users);
                        ...
                        <tr>
                            <td>
                                ...
                                <?php $emp_sections_array= get_list(SECTIONS, NULL, array('section_id'=>$users['emp_section_id'])); //pre($emp_sections_array); ?>
                            </td>
                            <td>
                            ...
                            <td>
                                <?php //echo $users['emp_section_id'];?>
                                 <?php $emp_section_array= get_emp_sections($users['emp_section_id']); //pre($emp_section_array);?>
