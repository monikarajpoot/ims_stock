    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box">
                ...
                <form role="form" method="post" action="<?php echo base_url() ?>admin_users/manage_user<?php if (isset($id)) {
                    echo '/' . $id;
                } ?>">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="box box-primary" style="margin-top: 15px;">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('emp_is_retired_label'); ?> <span class="text-danger">*</span></label>
                                    <?php $yesno_array = yesno_array(); //pre($yesno_array);  ?>
                                    <select class="form-control" name="emp_is_retired">
                                        <option value="">Select</option>
                                            <?php foreach ($yesno_array as $yky => $yval) { ?>
                                                <option value="<?php echo $yky; ?>" <?php if (@$emp_detail['emp_is_retired'] == $yky) {echo 'selected';} else if ($this->input->post('emp_is_retired') == $yky) {echo 'selected';} ?>><?php echo $yval; ?></option>
                                            <?php } ?>
                                    </select>
