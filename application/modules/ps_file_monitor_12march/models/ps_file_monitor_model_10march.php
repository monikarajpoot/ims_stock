...
class Ps_file_monitor_model extends CI_Model {
    ...
    function ps_monitor_files($task = null, $param1 = null , $param2 = null) {
        ...
        if(isset($_GET['sort']) && $_GET['sort']=='rc'){
            $this->db->where(array($tbl1.'.file_hardcopy_status'=>'received'));
            $this->db->or_where(array($tbl1.'.file_hardcopy_status'=>'working'));
        }else if(isset($_GET['sort']) && $_GET['sort']=='close'){
