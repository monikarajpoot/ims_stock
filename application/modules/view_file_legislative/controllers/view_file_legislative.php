...
class View_file_legislative	 extends MX_Controller {
    ...
    public function return_fileofficer($file_id = null)
    {
        ...
        $query = $this->db->query("SELECT ft_employee.emp_full_name_hi, ft_employee.emp_id ,ft_employee.role_id , ft_emprole_master.emprole_name_hi , ft_sections_master.section_name_hi, ft_sections_master.section_id FROM ft_employee inner join ft_emprole_master on ft_emprole_master.role_id = ft_employee.role_id left join ft_sections_master on ft_sections_master.section_id = ft_employee.emp_section_id  WHERE (ft_employee.role_id < '9' AND ft_employee.role_id > '".$role1[0]['role_id']."'  AND ft_employee.role_id not in ('9','1','2')) or ft_employee.role_id ='37' and ft_employee.emp_status = '1' and ft_employee.emp_is_retired = '0'  order by ft_employee.role_id asc");
    ...
    {
        $res_1 = $this->view_file->get_DAname_ajax(getEmployeeSection());
