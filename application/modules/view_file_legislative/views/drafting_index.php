...
<script type="text/javascript">
    $(function () {
        ...
        $(".rty1").click(function () {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var otpt = '<select class="form-control" name="emp_id"><option value="">सहायको का चयन करें</option> ';
        ...
        //Get upper user name
        $(".all_sections_nm").click(function () {
            var file_id = $(this).val();
            var HTTP_PATH='<?php echo base_url(); ?>';
            $.ajax({
                type: "POST",
    ...
    function section_section_move(file){
        var filess = file;
        $('#modal-send_upper').modal('show');
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <select class="form-control" name="section_mark1" id="section_mark1" required="">
                                            ...
                                            <option value="4">Return to Department (जावक)</option>
                                        </select>
                                    </div>
