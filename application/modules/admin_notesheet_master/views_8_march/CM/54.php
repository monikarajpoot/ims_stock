...
if($is_genrate == true){
    $contents .= $post_data['test1'];
}else{
    $contents .= '<input type="text" name="test1" class="date1"/>';
}
...
$contents .= '</div></td></tr>';
$contents .= '<tr><td></td><td align="right"><div class="law_dept" >मध्यप्रदेश शासन विधि और विधायी कार्य विभाग, भोपाल</div></td></tr>';	
