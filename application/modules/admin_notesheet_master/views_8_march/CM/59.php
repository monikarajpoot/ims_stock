...
$contents .= '<div> अपील प्रस्ताव के संबंध में नस्ती के परीक्षण के लिए जानकारी निम्नानुसार है :-<br/><br/></div></td></tr>';
$contents .= '<tr><td colspan="2"><br /><div style="text-align:justify" class="text-justify">1. न्यायालय का पूर्ण नाम जिसके विरूद्ध अपील प्रस्तुत की जानी है । <br/>';
if($is_genrate == true){
...
$contents .= '</div></td></tr>';
$contents .= '<tr><td colspan="2"><br /><div  style="text-align:justify" >2.  म0प्र0 शासन विरूद्ध '.$case_parties1[0].' के मामले में अपील प्रस्तावित की गई है ।</div><br/></td></tr>';
$contents .= '<tr><td colspan="2"><div  style="text-align:justify" >3. ';
if($is_genrate == true){
...
$contents .= '<tr><td colspan="2"><br /><div  style="text-align:justify" >4. ';
if($is_genrate == true){
...
$contents .= '</div></td></tr>';
$contents .= '<tr><td colspan="2"><br /><div  style="text-align:justify" >5. ';
if($is_genrate == true){
    $contents .= $post_data['dosh_mukti'];
}else{
	$contents .= '__';
...
$contents .= '<tr><td colspan="2"><br /><div  style="text-align:justify" >6.';
if($is_genrate == true){
    $contents .= $post_data['dosh_mukti'];
}else{
	$contents .= '__';
...
$contents .= '<tr><td colspan="2"><br /><div  style="text-align:justify">7. साक्षियों के कथनों की प्रतिलिपि संलग्न  ';
if($is_genrate == true){
...
$contents .= ' |</div></td></tr>';
$contents .= '<tr><td colspan="2"><br /><div  style="text-align:justify">8. ';
if($is_genrate == true){
    $contents .= $post_data['dosh_mukti'];
}else{
	$contents .= '__';
...
$contents .= ' । </div</td></tr>';
$contents .= '<tr><td colspan="2"><br /><div  style="text-align:justify">9. ';
if($is_genrate == true){
    $contents .= $post_data['dosh_mukti'];
}else{
	$contents .= '__';
...
$contents .= '<tr><td colspan="2"><br /><div  style="text-align:justify">10. प्रकरण अवधि बाह्य प्राप्त  ';
if($is_genrate == true){
...
.officer-center{ width:70%; text-align:center; font-weight:bold }
