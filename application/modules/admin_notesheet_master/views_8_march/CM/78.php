...
$contents  .= '<tr><td></td><td class="top_class"> 1. </td><td><p text-justify>';
if($is_genrate == true){
...
$contents  .= '<tr><td></td><td class="top_class"> 2. </td><td><p text-justify> जिला दण्डाधिकारी, ';
 if($is_genrate == true){
...
}else
{
 ...
 $contents  .= '<tr><td></td><td class="top_class"> 3. </td><td><p text-justify>  पुलिस अधीक्षक,';
if($is_genrate == true){
...
$contents  .= '<tr><td></td><td class="top_class"> 4. </td><td><p text-justify>  आयुक्त ';
if($is_genrate == true){
