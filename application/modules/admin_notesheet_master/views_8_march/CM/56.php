...
$contents .= '<p class="text-justify shift-left">राज्य शासन द्वारा उपरोक्त विषयांतर्गत एवं संदर्भित प्रकरण में दोषमुक्ति के निर्णय के विरूद्ध उक्त अभियुक्तगण  ';
if($is_genrate == true){
...
$contents .= ' तक हैं ।<br />';
$contents .= '</p></td></tr><tr><td></td><td colspan="2">';
$contents .= ' <p class="text-justify shift-left"> अत: आप राज्य शासन द्वारा लिये गये निर्णय के अनुसार दं.प्र.सं. की धारा 378 के अंतर्गत मध्यप्रदेश उच्च न्यायालय ';
if($is_genrate == true){
    $contents .= '<span>'.$post_data['court_location2'].'</span>';
}else{
    $contents .= '__';
...
if($is_genrate == true){
    ...
    $contents .= '<input type="text" name="text3" class="date1"/>';
}
...
if($is_genrate == true){
    ...
    $contents .= '<input type="text" name="text4" class="date1"/>';
}
...
$contents .= 'की सूचना शीघ्र विधि विभाग को प्रेषित करें ।';
$contents .= '</p></td></tr><tr><td></td><td colspan="2">';
$contents .= '<br /><br /><b>(सचिव विधि द्वारा अनुमोदित)</b><br /><b><u>संलग्न दस्तावेज :</u></b><br /> 1-निर्णय की सत्य प्रतिलिपि,<br />';
$contents .= '2-लोक अभियोजक का मत,<br />3-साक्षियों के कथन,<br /></p></td></tr><tr>';
   $contents .= '<tr><td colspan="3">&nbsp;</td></tr>';
	$contents  .= '<tr><td colspan="2"></td><td align="right"><div class="">मध्यप्रदेश के राज्यपाल के नाम से तथा आदेशानुसार, </div></td></tr><tr>';
