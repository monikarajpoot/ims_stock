...
$contents .= '<tr><td></td><td>आर. पी. शरण,<br>सचिव<br>मध्यप्रदेश शासन<br> विधि और विधायी कार्य विभाग, भोपाल<br></td></tr>';
...
$contents .= '<tr><td colspan="2">&nbsp;</td></tr>';
$contents .= '<tr><td colspan="2" align="right"><div class="officer-center">( ';
if($is_genrate == true){
...
.officer-center{ width:50%; text-align:center; font-weight:bold }
