...
$contents .= '<tr><td><p>उपरोक्त विषयांकित प्रकरण जिला  दणधिकारी  ';
 if($is_genrate == true){
...
$contents .= '<tr><td><p> उक्त संबंध में लेख है कि सामान्य प्रशासन विभाग के परिपत्र दिनांक  5.9.14 ' ;
 ...
 $contents .=  'के अनुक्रम में अभियोजन स्वीतकृति  संबंधी कार्यवाही प्रशासकीय विभाग द्वारा की जाना है । </p></td></tr>';
$contents .= '<tr><td><p> अत: निर्देशानुसार प्राप्त प्रकरण मूलत: आपकी ओर आवश्यक कार्यवाही हेतु संलग्न प्रेषित कर अनुरोध है कि अभियोजन स्वीकृति संबंधी कार्यवाही समय सीमा में पूर्ण कर की गई कार्यवाही से इस विभाग को एवं जिला दण्डाधिकरी';
if($is_genrate == true){
...
$contents .= '<tr><td>&nbsp;</td></tr>';
$contents .= '<tr><td align="right"><div style="width:60%; text-align:center;">( '.$us_name .')</div></td></tr>';
