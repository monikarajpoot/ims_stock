...
$contents .= '<tr><td colspan="3"> <br /><div style="float:right; width:70%; text-align:center"><b>(';
if($is_genrate == true){
...
$contents .= '<tr><td colspan="3" align="right" ><div  style="width:70%; text-align:center">'.$dept_name.'</div><br/></td></tr>';
?>