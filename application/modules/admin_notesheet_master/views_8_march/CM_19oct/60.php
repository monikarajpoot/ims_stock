...
$contents .= '<tr><td align="center" colspan="2">&nbsp; &nbsp;<br />-------------------------------<br />&nbsp;&nbsp;</td></tr>';
...
$contents .= '<div>1. न्यायालय का पूर्ण नाम जिसके विरूद्ध अपील प्रस्तुत की जानी है ।<br />';
if($is_genrate == true){
    $contents .= $post_data['dt2'];
}else{
    $contents .= '<input type="text" name="dt2"/></div><br/>';
}
$contents .= '<div>2. म0प्र0 शासन विरूद्ध '.$case_parties1[0].'</span>&nbsp;के मामले में अपील प्रस्तावित की गई है ।</div><br />';
$contents .= '<div>3. ';
if($is_genrate == true){
