...
$contents .= '<tr><td align="left" style="text-align: justify;"><p>&nbsp;&nbsp;&nbsp;&nbsp;कृपया प्रशासकीय विभाग की टीप दिनांक ';
if($is_genrate == true){
    $contents .= $post_data['dt1'];
}else{
    $contents .= '<input type="text" name="dt1" class="date1"/>';
}
$contents .= ' का अवलोकन करने का कष्ट करें । </p><p>&nbsp;&nbsp;&nbsp;&nbsp;प्रशासकीय विभाग ने प्रकरण में प्रभारी अधिकारी की नियुक्ति करे ';
$contents .= 'प्रतिरक्षण जरी करने हेतु नस्ती अंकित की है ।</p><p>&nbsp;&nbsp;&nbsp;प्रशासकीय विभाग ने माननीय उच्च न्यायालय &nbsp;';
if($is_genrate == true){
...
$contents .= '<tr><td align="left"><br><br><br> अनुभाग अधिकारी (आप.) <br><br><br>अति. सचिव <br><br></td></tr></tbody></table>';
?>
