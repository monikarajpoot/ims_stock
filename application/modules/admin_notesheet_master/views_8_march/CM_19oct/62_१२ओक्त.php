...
$contents .= '<tr><td align="left" colspan="3"><br><p> कृपया ';
if($is_genrate == true){
    $contents .= $post_data['advocate_type'];
}else{
    $contents .= '<input type="text" name="advocate_type" >';
}
$contents .= ' ';
if($is_genrate == true){
    $contents .= $post_data['court_location'];
}else{
    $contents .= '<input type="text" name="court_location" >';
}
$contents .= ' से प्राप्त पत्र एवं सह पत्रो सहित अवलोकन हो | <br>';
$contents .= '<br><br><p>माननीय उच्च न्यायलय ने  ';
if($is_genrate == true){
...
if($is_genrate == true){
    ...
    $contents .= '<input type="text" name="date_11" class="date_1"/>';
}
$contents .= ' को ';
if($is_genrate == true){
    $contents .= $post_data['prmanit'];
}else{
	$contents .=  '<input type="text" name="prmanit" />';
}
