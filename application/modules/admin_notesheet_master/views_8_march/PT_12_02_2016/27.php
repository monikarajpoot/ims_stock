...
$contents .= '<tr><td align="left"><div style="float:left; width:10%;">विषय:- </div> <div style="float:left; width:90%;">रिट याचिका क्रं0  '.$case_no;
if($is_genrate == true){ 
...
$contents .= '<tr><td align="left"><p>प्रशासकीय विभाग द्वारा रिट अपील प्रस्ताव ';
if($is_genrate == true){ 
...
$contents .= '<tr><td align="left"><p>अत: ';
if($is_genrate == true){ 
    $contents .=  $post_data['option_for'];
} else {
	$contents .= ' <select name="option_for" class="">';
...
$contents .= ' के संदर्भ में नस्ती सहित भेजकर लेख है कि प्रकरण के प्रभारी अधिकारी को निर्देश दे कि वह तत्काल';
 ...
 $contents .= ' में रिट अपील प्रस्तुत करने की कार्यवाही करें। साथ ही देरी के तथ्य को स्पष्ट करने का उत्तरदायित्व प्रशासकीय विभाग का होगा।</p>';
$contents .= '<tr><td>&nbsp;</td></tr>';
$contents .= '<tr><td align="right"><div style="width:50%; text-align:center;">(';
