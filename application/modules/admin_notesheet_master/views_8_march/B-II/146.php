...
if($is_genrate == true){ 
    ...
    $contents .= '<input type="text" class="distic_1 adv_distic" name="adv_distic1" value=""/>';
}
...
if($is_genrate == true){ 
    ...
    $contents .= '<input type="text" class="notriname adv_name" name="adv_name1" value=""/>';
}
$contents .= ', नोटरी  जिला  ';
if($is_genrate == true){ 
    $contents .=  $post_data['adv_distic2'];
} else {
    $contents .= '<input type="text" class="distic_1 adv_distic" name="adv_distic2" value=""/>';
}
$contents .= ' की तहसील  ';
if($is_genrate == true){ 
    $contents .=  $post_data['adv_tahsil1'];
} else {
    $contents .= '<input type="text" class="adv_tahsil tahsil" name="adv_tahsil1" value=""/>';
}
...
if($is_genrate == true){ 
    ...
    $contents .= '<input type="text" class="notriname adv_name" name="adv_name2" value=""/>';
}
...
if($is_genrate == true){ 
    ...
    $contents .= '<input type="text" class="distic_1 adv_distic" name="adv_distic3" value=""/>';
}
$contents .= ' की तहसील  ';
if($is_genrate == true){ 
    $contents .=  $post_data['adv_tahsil1'];
...
if($is_genrate == true){ 
    $contents .=  $post_data['adv_posting_date1'];
} else {
    $contents .= '<input type="text" class="adv_posting_date" name="adv_posting_date1" value=""/>';
}
$contents .= ' से दिनांक   ';
if($is_genrate == true){ 
    $contents .=  $post_data['post_renew_date'];
} else {
    $contents .= '<input type="text" class="post_renew_date" name="post_renew_date" value=""/>';
}
...
if($is_genrate == true){ 
    ...
    $contents .= '<input type="text" class="notriname adv_name" name="adv_name3" value=""/>';
}
$contents .= ', नोटरी  जिला  ';
if($is_genrate == true){ 
    $contents .=  $post_data['adv_distic4'];
} else {
    $contents .= '<input type="text" class="distic_1 adv_distic" name="adv_distic4" value=""/>';
}
$contents .= ' की तहसील  ';
if($is_genrate == true){ 
    $contents .=  $post_data['adv_tahsil3'];
} else {
    $contents .= '<input type="text" class="adv_tahsil tahsil" name="adv_tahsil3" value=""/>';
}
...
if($is_genrate == true){ 
    ...
    $contents .= '<input type="text" class="notriname adv_name" name="adv_name4" value=""/>';
}
$contents .= ' को जिन्होंने अपना सामान्य वृत्तिक पता- <b>';
if($is_genrate == true){ 
    $contents .=  $post_data['addres_hi'].',';
} else {
    $contents .= '<input type="text" class="addres" name="addres_hi"  value=""/>,';
}
if($is_genrate == true){ 
...
if($is_genrate == true){ 
    ...
    $contents .= '<input type="text" class="notriname adv_name" name="adv_name5" value=""/>';
}
...
$contents .= ' <b>"जिला  ';
if($is_genrate == true){ 
    $contents .=  $post_data['adv_distic5'];
} else {
    $contents .= '<input type="text" class="distic_1 adv_distic" name="adv_distic5" value=""/>';
}
$contents .= ' की तहसील ';
if($is_genrate == true){ 
    $contents .=  $post_data['adv_tahsil4'];
} else {
    $contents .= '<input type="text" class="adv_tahsil tahsil" name="adv_tahsil4" value=""/>';
}
$contents .= '"</b>';
...
if($is_genrate == true){ 
    ...
    $contents .= '<input type="text" class="notriname adv_name" name="adv_name6" value=""/>';
}
...
if($is_genrate == true){ 
    ...
    $contents .= '<input type="text" class="notriname adv_name" name="adv_name7" value=""/>';
}
...
$contents .= ' को रू0 1000/- (रू0 एक हजार) केवल का, जो कि नोटरी रूल्स, 1956 के नियम 9 के अधीन विहित की गयी प्रमाण-पत्र के नवीनीकरण संबंधी फीस है, भुगतान कर दिया है तथा नवीनीकरण का प्रमाण-पत्र जारी किये जाने के लिये स्टाम्प शुल्क रू0 1000/- (रू0 एक हजार) केवल का भी भुगतान कर दिया है| </p></td></tr>';
...
if($is_genrate == true){ 
    ...
    $contents .= '<input type="text" class="notriname adv_name" name="adv_name8" value=""/>';
}
...
$contents .= ' <b>"जिला  ';
if($is_genrate == true){ 
    $contents .=  $post_data['adv_distic6'];
} else {
    $contents .= '<input type="text" class="distic_1 adv_distic" name="adv_distic6" value=""/>';
}
$contents .= ' की तहसील ';
if($is_genrate == true){ 
    $contents .=  $post_data['adv_tahsil5'];
} else {
    $contents .= '<input type="text" class="adv_tahsil tahsil" name="adv_tahsil5" value=""/>';
}
$contents .= '"</b>';
