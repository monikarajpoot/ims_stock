...
$contents .= ' अधिवक्ता एवं नोटरी, तहसील ';
if($is_genrate == true){ 
    $contents .=  '<b>'.$post_data['tahsil'].'</b>';
} else {
...
$contents .= '<tr><td align="center"><b><u>पंजी क्रं r';
if($is_genrate == true){ 
    $contents .=  '<b>'.$post_data['file_number'].'</b>';
} else {
    $contents .= '<input type="text" name="file_number"  value=""/>';
...
$contents .= ' को सहपत्रों सहित अपनी अनुशंसा के साथ इस विभाग को प्रेषित किया है। जांच प्रतिवेदन  संलग्न है | </p></td></tr>';
$contents .= '<tr><td><p>';
if($is_genrate == true){ 
    $contents .=  '<b>'.$post_data['notriname'].'</b>';
} else {
...
$contents .= ' को समाप्त होने वाली समयावधि तक के लिये जारी अपने नोटरी व्यवसाय प्रमाण-पत्र को समयावधि पूर्व आगामी 5 वर्ष तक के लिये नवीनीकरण किये जाने का अनुरोध किया हैं। आवेदन-पत्र के साथ नोटरी नियम,1956 के अनुसार नोटरी व्यवसाय प्रमाण-पत्र नवीनीकृत किये जाने के संबंध में देय शुल्क रूपये 1000/- (रूपये एक हजार) केवल कोषालय में जमा किये जाने के चालान क्रमांक ';
if($is_genrate == true){ 
...
$contents .= ' की मूल प्रति एवं रूपये 1000/- (रूपये एक हजार) केवल का नान-ज्यूडिशियल स्टाम्प संलग्न है| </p></td></tr>';
$contents .= '<tr><td><p>';
if($is_genrate == true){ 
    $contents .=  '<b>'.$post_data['notriname'].'</b>';
} else {
...
if($is_genrate == true){ 
    ...
    $contents .= '<input type="text" class="adv_posting_date" name="todate"  value="'.$today.'"/>';
}
$contents .= ' से पांच वर्ष के लिए दिनांक ';
if($is_genrate == true){ 
    $contents .=  '<b>'.$post_data['from_name'].'</b>';
} else {
    $contents .= '<input type="text" class="post_renew_date notri_fromdate" name="from_name"  value="'.date('d-m-Y',strtotime($today."+ 5 years")).'"/>';
}
...
$contents .= '<tr><td><div style="height:100px;"></div></td></tr>';
//page 2

$contents .= '<tr><td align="left"><div style="margin-top:10px;"><span style="margin-left:10%;">';
if($is_genrate == true){ 
    $contents .=  '<b>'.$post_data['notriname'].'</b>';
} else {
    $contents .= '<input type="text" class="notriname adv_name" name="notriname"  value="श्री "/>';
...
$contents .= ' के कार्य एवं आचरण के संबंध में कहीं से भी कोई शिकायत प्राप्त नहीं हुई है। इसलिये ';
if($is_genrate == true){ 
    $contents .=  '<b>'.$post_data['notriname'].'</b>';
} else {
    $contents .= '<input type="text" class="notriname adv_name" name="notriname"  value="श्री "/>';
...
$contents .= '<tr><td align="left"><div style="margin-top:280px;"><span style="margin-left:10%;">';
if($is_genrate == true){ 
    $contents .=  '<b>'.$post_data['notriname'].'</b>';
} else {
    $contents .= '<input type="text" class="notriname adv_name" name="notriname"  value="श्री "/>';
