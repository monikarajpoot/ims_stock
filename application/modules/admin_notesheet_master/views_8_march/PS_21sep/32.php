...
$contents .= 	' एस.टी.एफ अ.क्र ';
if($is_genrate == true){
$contents .= $post_data['stf_no_1'];
}else{
$contents .= 	'<input type="text" name="stf_no_1">';

} 
$contents .= 	'</p></td></tr>'; 

$contents .= '<tr><td align="center">---------0---------</td></tr>';
$contents .= '<tr><td><p>कृपया लोकायुक्त  कार्यालय भोपाल राज्य अर्थिक अपराध से प्राप्त अभियोजन स्वीकृति संबंधी प्रस्ताव का अवलोकन करें । </p></td></tr>';
...
$contents .= ' तक गवाहान कथन  की छायाप्रति पृ.01 से पृ';
if($is_genrate == true){
...
$contents .= '<tr><td><p>	सामान्य प्रशासन विभाग के आदेश दिनांक 05.09.2014 के अनुक्रम में प्रकरण इस विभाग को विशेष पुलिस स्थापना, लोकायुक्त /ब्यूरो कार्यालय द्वारा अभियोजन स्वीकृति हेतु भेजा गया है। अत: उक्त प्रस्तावानुसार प्रकरण प्रशासकीय विभाग ';
if($is_genrate == true){
$contents .= $post_data['dept'];
}else{
$contents .= '<input type="text" name="dept">';
}

$contents .= ' की ओर आवश्यक कार्यवाही करने हेतु भेजा जाना उचित प्रतीत होता है। साथ ही इसकी सूचना लोकायुक्त कार्यालय को भी भेजी जाना उचित होगा।</p></td></tr>';


$contents .= '<tr><td><p>	अत: अर्धशासकीय पत्र की स्वच्छ प्रतियां हस्ताक्षरार्थ प्रस्तुत हैा</p></td></tr>';
$contents .= '<tr><td>&nbsp;</td></tr>';
$contents .= '<tr><td>( ';
if($is_genrate == true){
$contents .= $post_data['section_officer'];
}else{
$contents .= '<input type="text" name="section_officer">';
}
$contents .= ') </td></tr>';
...
$contents .= '<tr><td>( ';
if($is_genrate == true){
$contents .= $post_data['us'];
}else{
$contents .= '<input type="text" name="us">';
}
$contents .= ' ) </td></tr>';
