...
$contents .= ' याचिका प्रकरण। </h5>	</td></tr>';
...
$contents .= '<tr><td align="center">
		<table id="bandi_notesheet" class="bandi_notesheet" border="1px" style="font-size:13px;">
...
$contents .= '<tr><td>';
if($is_genrate == true){
$contents .= ' '.$post_data['uper_secetry'];
}else
{
	$contents .=  '<input type="text" name="uper_secetry" />';
} 
$contents .='</td></tr>';
