<?php 
$contents  = '' ;
$contents .= '<tr><td> <div style="margin-top:15px;"><span style="margin-left:10%;"> प्रकरण वापसी ';
if($is_genrate == true){
$contents .= $post_data['subject'];
}else
{
	$contents .=  '<textarea cols="140" name="subject"  /></textarea>';
}
...
$contents .= '<tr><td><p>प्रकरण परीक्षण एवं मतपर्स पस्तुत है ।</p>
</td></tr>';
