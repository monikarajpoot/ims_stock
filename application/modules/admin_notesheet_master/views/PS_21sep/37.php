...
<?php 
$contents  = '' ;
$contents .= '<tr><td><div style="margin-top:15px;"><span style="margin-left:10%;">अभियोजन स्वीकृति हेतु आवेदन पत्र श्री ';
if($is_genrate == true){
...
$contents .= '<tr><td>( ';
if($is_genrate == true){
$contents .= $post_data['addional_sectry'];
}else
{
	$contents .=  '<input type="text" name="addional_sectry" />';
} 
$contents .=  ' )</td></tr>';
...
$contents .= '<tr><td>( ';
if($is_genrate == true){
$contents .= $post_data['avar_sectry'];
}else
{
	$contents .=  '<input type="text" name="avar_sectry" />';
} 
$contents .=  ' )</td></tr>';
