...
<script type="text/javascript">
    $(function () {
		...
		$(document).ready(function () {
			$("#show_content").text("अत: विलम्ब का दायित्व त्रुटिकर्ता अधिकारी का रहेगा, माननीय सर्वोच्चय न्यायालय में धारा-5 लिमिटेशन एक्ट का आवेदन मय शपथ-पत्र के प्रस्तुत किया जाएगा, जिसमें दिन-प्रतिदिन के विलम्ब को स्पष्ट किया जाएगा ।");
			$("#show_hide").click(function() {
				//alert("show content");
				$("#show_content").text("विलम्ब का दायित्व त्रुटिकर्ता अधिकारी का रहेगा, वह माननीय सर्वोच्च न्यायालय में धारा 5 लिमिटेशन एक्ट का आवेदन मय शपथ-पत्र के प्रस्तुत करते हुए, दिन प्रतिदिन के विलम्ब को स्पष्ट करेगा, विलम्ब का दायित्व विधि विभाग का नहीं रहेगा ।");
				//$("#hide_btn").hide();
				$("#show_hide").hide();
				$("#hide_show").show();
			})	
