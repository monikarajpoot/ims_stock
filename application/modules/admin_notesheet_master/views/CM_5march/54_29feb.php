...
$contents .= '---000---';
$contents .= '</td></tr><tr>';
$contents .= '<tr><td align="left" class="style1" colspan="3"><div style="width: 64px; float: left; display: block; border: 1px solid #fff;"></div>';
$contents .= 'कृपया उपरोक्त संदर्भित पत्र का अवलोकन करें ।<br /><br />';
$contents .= '</td></tr>';
$contents .= '<tr><td align="left" class="style1" valign="top" colspan="3"><div style="width: 64px; float: left; display: block; border: 1px solid #fff;"></div>';
