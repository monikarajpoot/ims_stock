...
<?php
//page 1
$contents  = '<table style="font-size:16px; margin:0% auto; width:80%;">' ;
...
if($is_genrate == true){
        $contents .= '<tr><td align="left"><b><u><span style="margin-left:8%"><b>'.$post_data['distic_1'].', म0प्र0</b></span></td></tr>';
} else {
    $contents .= '<tr><td align="left">';
	$contents .= get_distic_dd('distic_1');
    $contents .= ', म0प्र0</u></b></td></tr>';
}
...
if($is_genrate == true){ 
    ...
    $contents .= '<input type="text" class="" name="grapan_date1"  value="'.$file_judgment_.'"/>';
}
...
if($is_genrate == true){ 
    $contents .= '<b>'.$post_data['to_date1'].'</b>';
} else {
    $contents .= '<input type="text" class=" notri_todate" name="to_date1"  value="'.$today.'"/>';
}
$contents .= ' से दिनांक   ';
if($is_genrate == true){ 
...
//page 2
$contents .= '<tr><td><div style="height:550px;"></div></td></tr>';
$contents .= '<tr><td align="center"><h5><u>'.$dept_name.',</u></h5></td></tr>';
