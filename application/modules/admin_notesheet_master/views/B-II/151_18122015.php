...
if($is_genrate == true){ 
    ...
    $contents .= '<input type="text" class="notriname" name="notriname"  value="श्री "/>';
}
...
if($is_genrate == true){ 
    ...
    $contents .= '<input type="text" class="" name="avedan_date"  value="'.$today.'"/>';
}
...
if($is_genrate == true){ 
    ...
    $contents .= '<input type="text" class="" name="notri_date"  value="'.$today.'"/>';
}
...
if($is_genrate == true){ 
    ...
    $contents .= '<input type="text" class="" name="chalan_no"  value=""/>';
}
$contents .= ' चालान  दिनांक ';
if($is_genrate == true){ 
    $contents .=  '<b>'.$post_data['chalan_date'].'</b>';
} else {
    $contents .= '<input type="text" class="" name="chalan_date"  value="'.$today.'"/>';
}
...
if($is_genrate == true){ 
    ...
    $contents .= '<input type="text" class=" notri_todate" name="todate"  value="'.$today.'"/>';
}
$contents .= ' से पांच वर्ष के लिए दिनांक ';
if($is_genrate == true){ 
    $contents .=  '<b>'.$post_data['from_name'].'</b>';
} else {
    $contents .= '<input type="text" class=" notri_fromdate" name="from_name"  value="'.date('d-m-Y',strtotime($today."+ 5 years")).'"/>';
}
...
if($is_genrate == true){ 
    ...
    $contents .= '<input type="text" class="notrino" name="notrino"  value=""/>';
}
...
$contents .= ' ने अपने नोटरी व्यवसाय प्रमाण-पत्र को नवीनीकृत किये जाने का आवेन-पत्र समयावधि समाप्त होने के पूर्व निर्धारित देय शुल्क जमा करने संबंधी चालान की  मूल प्रति व नान-ज्यूडिशियल स्टाम्प के साथ जिला एवं सत्र न्यायाधीश ने उनके नोटरी व्यवसाय प्रमाण-पत्र को नवीनीकृत किये जाने की अनुशंसा की है, उनके कार्य एवं व्यवहार के संबंध में कोई शिकायत प्राप्त न होने का उल्लेख किया है। इस विभाग में ';
if($is_genrate == true){ 
    $contents .=  '<b>'.$post_data['notriname'].'</b>';
} else {
    $contents .= '<input type="text" class="notriname" name="notriname"  value="श्री "/>';
...
$contents .= ' अधिवक्ता के नोटरी व्यवसाय प्रामण-पत्र को आगामी पांच वर्ष अर्थात् दिनांक ';
if($is_genrate == true){ 
