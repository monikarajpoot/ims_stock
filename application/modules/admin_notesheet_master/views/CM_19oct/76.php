...
$contents .=  'वरिष्ट अधिवक्ता, उच्चम न्यायालय, नई दिल्ली को इस विभाग के आदेश दिनांक ';
if($is_genrate == true){
...
$contents  .= 'में  वर्णित सेवा शर्तो के आधीन, माननीय उच्चम न्यायालय के समक्ष राज्य की ओर से उनके द्वारा निम्नलिखित दिनांको में ';
if($is_genrate == true){
...
$contents  .= '<tr><td><p>विधि परामर्शी मध्यप्रदेश शासन क्रप्या ';
if($is_genrate == true){
...
$contents  .= ', कनिष्ठ अधिवक्ता, उच्चम न्यायालय, नई दिल्ली को उपरोक्त धनराशि का भुगतान ई-पैमेन्ट के माधयम से करें | </p></td></tr>';
