...
$contents .= '</td></tr><tr>';
$contents .= '<td align="left" colspan="3">';
$contents .= 'OF <b><u>'.strtoupper($agenst_name).'</u></b>';
...
{
       $contents  .= '  <select name="DropDownList_secretory" id="DropDownList_secretory"><option>R.P. SARAN</option><option>J.K. Vaidya </option> </select>';
...
$contents .= '</div></td></tr>';
$contents .= '<tr><td align="left" colspan="2"><br />Dated this the <b>';
