...
$contents .= '<span id="l2">(म.प्र.)</span>&nbsp;के&nbsp;<span id="Label6">CR</span>';
$contents .= '&nbsp;प्रकरण क्रमांक '.$case_no.'&nbsp; '.$case_parties1[2].' '.$case_parties1[1].' '.$case_parties1[0].'  के मामले में अभियुक्तगण को';
...
$contents .= @$this->input->post('adname') && $is_genrate == true ? $this->input->post('adname') : '<input name="adname" type="text" id="TextBox5" value="रजनी पंचोली" />';
$contents .= ') <br />';
if($is_genrate == true){
