...
$contents  .= '  ( म0प्र0) | </p></td></tr><tr><td></td><td class="top_class" >2.</td><td ><p>' ;
if($is_genrate == true){
...
$contents  .= ' (म0प्र0) | </p></td></tr><tr><td></td><td valign="top" class="top_class">3. </td><td ><p>महानिरीक्षक (प0) विशेष पुलिस स्थापना, लोकायुक्त कार्यालय, भोपाल (म.प्र.) के पत्र क्रमांक '.@$file_uo_or_letter_no .' अप०क्र०';
if($is_genrate == true){
...
$contents  .= ' दिनांक '.@$file_uo_or_letter_date .' के संदर्भ में इस निर्देश के साथ प्रेषित की जाती है कि उपरोक्त प्रकरण में तत्काल प्रभारी अधिकारी की नियुक्ति करें व प्रभारी अधिकारी को निर्देशित करें कि  वे विशेष लोक अभियोजक से सम्पर्क कर अपील प्रस्तुत करें, और प्रकरण से संबंधित केस डायरी, साक्ष्य में ग्राह्य दस्तावेजों की प्रतिलिपियां, परीक्षित साक्षियों के कथन एवं अन्य सुसंगत दस्तावेज । प्रकरण में पैरवी करने वाले अतिरिक्त महाधिवक्ता को उपलब्ध कराया जाना सुनिश्चित करें और की गई कार्यवाही से इस विभाग को सूचित करें ।  <span class="font-large">साथ ही भविष्य में भेजे जाने वाले अपील प्रस्ताव के साथ निर्णय की दो प्रमाणित प्रतिलिपिया संलग्न कर आवश्यक रूप से इस विभाग को भेजा जाना सुनिश्चित करें|</p></td></tr><tr><td></td><td class="top_class">4.</td><td ><p>' ;
...
$contents  .= '</p></td></tr><tr><td></td><td class="top_class">5.</td><td ><p>';
...
$contents  .= '</p></td></tr><tr><td></td><td>';
$contents .= '<tr><td  colspan="3" height="80"></td></tr>';
$contents .= '<tr><td colspan="3" align="right"><div class="officer-center">( ';
if($is_genrate == true){
$contents .= $post_data['secetroy'];
}else
{
	 $contents .= get_officer_for_sign('secetroy' ,$secetry , getEmployeeSection());
...
if($is_genrate == true){	
    $contents .=  get_officer_for_sign_dign("design",$secetry,$this->input->post('secetroy'));
}
else {
	 $contents .= '-------';
	}
