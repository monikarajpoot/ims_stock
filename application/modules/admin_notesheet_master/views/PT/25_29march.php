...
if($is_genrate == true){
	...
	foreach(get_advocates_name('', $post_data['member_id']) as $row){
        $contents .= ' '.$row->scm_name_hi.'</span></td></tr><tr><td align="left"><span style="margin-left:8%"> '.$row->scm_post_hi.'</tr><tr>';
    }
	$contents .= '</span></td></tr>';
	...
	$contents .= '</select><select name="member_id"><option ></option>';
...
$contents .= '<tr><td align="right">&nbsp;<div class="singed_verify"></div></td></tr>';
