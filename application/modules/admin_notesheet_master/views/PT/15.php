...
/*End Is value Post*/
$contents='<tr colspan="1"><td><div style="margin-top:20px;"><b style="margin-left:50px;">विशेष अनुमति याचिका क्रमांक '.$file_details[0]['case_no'].' में प्रतिरक्षण हेतु|</b></div></td><tr/><tr><td>पंजी क्रमांक';?>
                    <?php $contents .='<input '.$cmn_style.' type="text" name="num" value="'.$file_number.'">'; ?>
                    <?php  $contents .='<b> '.$panji_no.'</b>/21-क(या0),<div style="float:right"> दिनांक  <b>'.$date1.'</b><input '.$cmn_style.' type="text" class="date1" name="date1" placeholder="dd/mm/yyyy" name="generate_date" value="'.$file_mark_section_date.'"/></div>';?>
                    <?php $contents .='</div></td></tr><tr><td align="center">'.$file_details[0]['dept_name_hi'].' विभाग  का</td></tr><tr><td><p><div style="float:left">यू.ओ.क्रमांक :  <b>'.$panji_uno.'</b><input '.$cmn_style.' type="text" name="uo_no" value="'.$file_details[0]['file_uo_or_letter_no'].'"></div><div style="float:right">
                       दिनांक ';?>
						...
						<?php $contents .='</div><br><br></p>
                               ...
                               <p>स्थायी अधिवक्ता   <b>'.$post_advocate.' </b> के नाम आदेश तथा वकालतनामा तथा प्रशासकीय विभाग की नस्ती पर अंकित टीप हस्ताक्षरार्थ प्रस्तुत है।</p>
