...
if($is_genrate == true){
	 $contents .= $post_data['addvocatename'];
}
else{
	 $contents .= '<input name="addvocatename" placeholder="" size="50" type="text" />' ;
}
...
if($is_genrate == true){
	 ...
	 $contents .= '<input name="virudh" placeholder="" size="30" type="text" />' ;
}
...
if($is_genrate == true){
	 ...
	 $contents .= '<input name="name1" placeholder="" size="50" type="text" />' ;
}
...
if($is_genrate == true){
	 ...
	 $contents .= '<input name="name2" placeholder="" size="50" type="text" />' ;
}
