...
$contents .= '/'.date("y").'/'.$panji_krmank.'/21-क(सि.),';
...
$contents .= '<tr><td></td><td>प्रमुख सचिव, </td></tr>';
...
$contents .= '<p>यथा निर्देशित लेख है कि प्रशासकीय विभाग ('.$file_department.') द्वारा ';
if($is_genrate == true){
	$contents .= '<b>'.$post_data['title_loc'].'</b>';
} else {
	$contents .= ' --------';
...
$contents .= '<tr><td  valign="top" ></td><td valign="top" colspan="2" >';
$contents .= '<p>विशेष अनुमति याचिका क्रमांक ';
if($is_genrate == true){
...
if($is_genrate == true){
	$contents .= '<b>'.$post_data['rupyra'].'</b>';
	 ...
	 $contents .= '<input type="text" name="rupyra" size="30" value="1,00,000 (एक लाख)" >';
}
$contents .= '  रूपए का हर्जाना अधिरौपित करते हुए विलंब के लिए उत्तरदायी अधिकारियों से हर्जाने की राशि वसूल करने हेतु आदेशित किया गया है। </p></td></tr>';
$contents .= '<tr><td  valign="top" ></td><td valign="top" colspan="2" >';
$contents .= '<p>विलंब से याचिका दायर करने के संबंध में मान्नीय सर्वोच्च न्यायालय द्वारा दिए गए दिशा-निर्देश के परिप्रेक्ष्य में वर्तमान प्रकरण में याचिका दायर करने में हुए विलंब के संबंध में दायित्व के निर्धारिण एवं विलंब के कारण के परीक्षण हेतु पृथक से नस्ती की प्रति विधि विभाग में गठित समीक्षा सेल को प्रेषित की गई है।</p></td></tr>';
$contents .= '<tr><td  valign="top" ></td><td valign="top" colspan="2" >';
$contents .= '<p >अतः यह अनुरोध है कि वर्तमान प्रकरण में याचिका दायर करने में हुए विलंब के संबंध में अपने अभिमत सहित दायित्व के निर्धारण एवं विलंब के कारण को दर्शित करते हुए सुसंगत दस्तावेज एवं विवरण विधि विभाग में गठित समीक्षा सेल को एक सप्ताह के भीतर उपलब्ध कराया जाना सुनिश्चित करें।</p></td></tr>';
