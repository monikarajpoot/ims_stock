...
$contents .= '</p></td></tr>';
$contents .= '<tr><td><div style="float:left; width:14%;"><b>सन्दर्भ:-</b></div><p style="text-indent: 0;"> प्रशासकीय विभाग ';
...
$contents .= '<tr><td align="left"><p>उपरोक्त विषयांतर्गत एवं संदर्भित प्रकरण में माननीय उचचतम न्यायलय ';
if($is_genrate == true){
...
$contents .= ' के प्रकरण क्रमांक '. $case_no.' मे पारित आदेश दिनांक '.get_date_formate($file_judgment_date,'d/m/Y').'   के विरुध्द माननीय उच्चतम न्यायालय के समक्ष विशेष अनुमति याचिका प्रशासकीय विभाग के उत्तरदायित्व पर दिन-प्रतिदिन के  विलंब का पर्याप्त कारण दर्शित करते हुये विलंब माफी के आवेदन–पत्र जो शपथ-पत्र से समर्थित होगा, सहित प्रस्तुत कर विधि विभाग को शीघ्र सूचित करें |</p></td></tr>';
...
$contents .= '<tr><td><p>2- सचिव, म.प्र. शासन, <b>'.$file_department.',</b> भोपाल की ओर उनके    यू.ओ.क्र  '.$file_uo_or_letter_no.' दिनांक '.get_date_formate($file_judgment_date,'d/m/Y').' के संदर्भ में उनकी विभागीय नस्ती सहित 
 ...
 $contents .= ' अधिवक्ता नई दिल्ली में संपर्क कर विशेष अनुमति याचिका उच्चतम न्यायलय नई दिल्ली के समक्ष प्रस्तुत किये जाने के लिए समुचित कार्यवाही करे |   </td></tr>';
$contents .= '<tr><td align="right"><div style="width:60%; text-align:center;">भवदीय,</div></td></tr>';
 $contents .= '<tr><td align="right">&nbsp;</td></tr>';
$contents .= '<tr><td align="right"><div style="width:60%; text-align:center;">(<b>'.$as_name.'</b>)</div></td></tr>';
$contents .= '<tr><td align="right"><div style="width:60%; text-align:center;">अतिरिक्त सचिव</div></td></tr>';
