...
$contents .= '<tr><td align="left"><div style="float:left; width:15%;">विषय:- </div> <div style="float:left; width:85%;">केन्द्रीय जेल,';
if($is_genrate == true){
...
$contents .=  ' के अंतर्गत समय पूर्व रिहाई प्रकरण ।</div></div></td></tr>';
$contents .= '<tr><td align="left"><div style="float:left; width:15%;">संदर्भ:- </div> <div style="float:left; width:85%;">आपका यू.ओ.क्रमांक  '.@$file_uo_or_letter_no.', दिनांक '.@$file_uo_or_letter_date.'</div ></div ></tr>';
...
$contents .= '<tr><td align="right"><div style="width:60%; text-align:center;"> अपर सचिव</div></td></tr>';
...
$contents .=  'की ओर सूचनार्थ एवं आवश्यलक कार्यवाही हेतु प्रेषित ।</p></td></tr>';
$contents .= '<tr><td><p>3- ';
if($is_genrate == true){
