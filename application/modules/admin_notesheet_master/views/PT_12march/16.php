<?php
$contents  = '' ;
$contents .= '<tr><td align="left"><div style="margin-top:20px;"><span style="margin-left:10%;">नेशनल ग्रीन ट्रीब्युनल सेन्ट्रल जोन भोपाल में आवेदन क्रं0 '.@$file_uo_or_letter_no;
if($is_genrate == true){ 
