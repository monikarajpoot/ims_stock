            ...
            <div class="form-group" id="other_file_div">
                ...
                <select class="form-control" name="other_file_type" id="other_file_type" required>
                    ...
                    foreach(file_other_type() as $key => $value){
                        if($key!='3'){
                            if($file_data[0]['file_form']==$key){
                                  $slct='selected';
                                  echo '<option value="'.$key.'" '.$slct.' >'.$value.'</option>';
                            }else if(isset($postdata['other_file_type'])){
...
$(function() {
        ...
        $('#other_file_type').change(function(){
            ...
            if(file_for==1){
                $('#file_mark_section_id').html("<?php echo $this->lang->line('label_mark_section'); ?><span class='text-danger'>*</span>");
