...
<div class="col-md-6">
    <div class="box box-primary">
        <div class="box-body">
            ...
            <div class="form-group" id="dept_id_show" <?php if($this->input->post('file_offer_by') == 'v') { echo "style='display: block'"; } else { echo "style='display: none'";} ?>>
                ...
                <select class="form-control" name="file_department_id" id="file_department_id">
                    ...
                    <?php foreach($departments_list as $row){ ?>
                        <option value="<?php echo $row['dept_id']; ?>" <?php  if($this->input->post('file_department_id')==$row['dept_id']){ echo 'selected';} ?>><?php echo @$row['department_default_no']==1000 ? '' : $row['department_default_no']." - "; ?><?php echo $row['dept_name_hi']; ?></option>
                    <?php } ?>
            ...
            <!---prastav end--->
			<div class="form-group" id="other_distict_name" >
                <label for="file_type"><?php echo $this->lang->line('label_distict_name'); ?></label> </label>
				<?php echo get_district_dd("distict_name" ,'class="form-control" ' ) ; ?>
			</div>
            ...
            <div class="form-group" id="">
                ...
                <select  class="form-control" name="mark_csu">
                    <option value="" <?php  if($this->input->post('mark_csu')== ''){ echo 'selected';} ?>>Mark to select section</option>
                    <option value="62" <?php  if($this->input->post('mark_csu')== '62'){ echo 'selected';} ?>>Center Scan Unit</option>
                </select>
            </div>
