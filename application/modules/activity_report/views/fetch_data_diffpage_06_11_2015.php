                    ...
                    <div class="box-body">
                        ...
                        <table class="table table-condensed">
                            ...
                            <tr>
								...
								<td id="file_in_progress" style="cursor:pointer" onclick="showpage('<?php echo base_url(); ?>reports/moniter?secid=<?php echo $get_section[0]['section_id'] ?>&s=working')"><span  class="badge bg-green"><b><?php echo $res0['total_working_file'] + $res1['total_recieved_file']; ?></b></span><br/>Total Files <br/>(E)</td>
                    ...
                    <table class="table table-condensed stripeTable12">
                        ...
                        if($qry->num_rows() != 0) {
                            ...
                            foreach($qry->result() as $record1){
								...
								?>
                                <tr class="stripeRow" <?php if($record1->designation_id<=7){ ?> style="background-color:#CECECE"<?php } ?>>
                                    <td><?php echo $i ;?>.</td>
                                    <td><?php  echo getemployeeName($record1->file_received_emp_id,true)." (".$emp1->emprole_name_hi.")" ;?></td>
                                    <td style="cursor:pointer" onclick="showpage('<?php echo base_url(); ?>reports/moniter?secid=<?php echo $get_section[0]['section_id'] ?>&s=received&emp=<?php echo $record1->file_received_emp_id; ?>')" class="qtr-1"><?php echo $record1->received; ?></td>
                                    <td style="cursor:pointer" onclick="showpage('<?php echo base_url(); ?>reports/moniter?secid=<?php echo $get_section[0]['section_id'] ?>&s=not&emp=<?php echo $record1->file_received_emp_id; ?>')" class="qtr-2"><?php echo $record1->notreceive; ?></td>
                                    <td  id="total_price" style="cursor:pointer" onclick="showpage('<?php echo base_url(); ?>reports/moniter?secid=<?php echo $get_section[0]['section_id'] ?>&emp=<?php echo $record1->file_received_emp_id; ?>')">
										<span data-toggle="tooltip" title="" class="badge bg-light-blue" data-original-title="<?php echo $record1->fileno; ?> File">
