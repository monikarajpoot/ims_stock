            ...
            <div class="box box-primary">
                <div class="box-body">
                    <table class="table table-condensed stripeTable12">
                        ...
                        /*Get employee id*/
                        $sql_qry_emp="SELECT group_concat(emp_id) AS section_emp_ids FROM `ft_employee` where emp_status ='1' and emp_is_retired = '0' and designation_id !='28' and designation_id !='30' and emp_section_id='".$get_section[0]['section_id']."'";
                            ...
                            $record1 = $qry->result() ;
                                ...
                                //}
                                    ...
                                    <tr class="stripeRow" <?php if(isset($record1[$j]->designation_id) && $record1[$j]->designation_id<=7){ ?> style="background-color:#CECECE"<?php } ?>>
                                        <td><?php echo $i ;?>. </td>
                                        <td  title="Click to show total numbers of files" style="cursor:pointer" onclick="showpage('<?php echo base_url(); ?>reports/moniter?secid=<?php echo $get_section[0]['section_id'] ?>&emp=<?php echo $section_all_empIds[$j]; ?>')"><?php  echo getemployeeName($section_all_empIds[$j],true)." (".$emp1->emprole_name_hi.")" ;?></td>
