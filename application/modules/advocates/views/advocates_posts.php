                        ...
                        <div class="box box-primary" style="margin-top: 15px;">
                            <div class="box-body">
								...
								<div class="form-group">
									...
									<input type="number" class="form-control" name="filled_posts" value="<?php echo isset($advocate_details['filled_posts'])? $advocate_details['filled_posts']:$this->input->post('filled_posts')?>">
									
								</div>
								<div class="form-group">
									<label><?php echo $this->lang->line('adv_vacancies_label'); ?>:</label>
									<input type="number" class="form-control" name="vacant_seats" value="<?php echo isset($advocate_details['vacant_seats'])? $advocate_details['vacant_seats']:$this->input->post('vacant_seats')?>">
								...
								<div class="form-group">
									...
									}else if($this->input->post('taluka_id')){
										 $selected  = $this->input->post('taluka_id') ;
									} ?>
									<?php echo get_taluka_ddl_list('taluka_id','class="form-control"',$selected ) ?>
