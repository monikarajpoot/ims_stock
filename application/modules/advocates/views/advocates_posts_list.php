                    ...
                    <tbody>
                      <?php $i=1; 
                        ...
                        <tr>
                            ...
                            <td><?php echo isset( $post['state_id'])? getState( $post['state_id']):''?></td>
                            <td><?php echo isset( $post['district_id'])? getDistrict_name($post['district_id']):'' ?></td>
                         <td><?php echo isset( $post['taluka_id'])? getTaluka_name($post['taluka_id']):'' ?></td>
                            <td>
                             <div class="btn-group">
